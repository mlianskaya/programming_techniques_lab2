# Лабораторная работа №2: Тестирование и сравнение алгоритмов поиска для записей об абитуриентах (вариант 16)
...
- хэш-таблица (с методом цепочек и структурой корзины «ключ → вектор значений»),  
- `std::multimap`.  
